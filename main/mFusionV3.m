%%%%%%%%%%%%%%%%%%%%%%%%%%% main func %%%%%%%%%%%%%%%%%%%%%%%%%%
function varargout = mFusionV3(varargin)
% MFUSIONV3 MATLAB code for mFusionV3.fig
%      MFUSIONV3, by itself, creates a new MFUSIONV3 or raises the existing
%      singleton*.
%
%      H = MFUSIONV3 returns the handle to a new MFUSIONV3 or the handle to
%      the existing singleton*.
%
%      MFUSIONV3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MFUSIONV3.M with the given input arguments.
%
%      MFUSIONV3('Property','Value',...) creates a new MFUSIONV3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mFusionV3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mFusionV3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help mFusionV3

% Last Modified by GUIDE v2.5 03-May-2024 10:31:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mFusionV3_OpeningFcn, ...
                   'gui_OutputFcn',  @mFusionV3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% openingfucntion %%%%%%%%%%%%%%%%%%%%%%%%%%
% --- Executes just before mFusionV3 is made visible.
function mFusionV3_OpeningFcn(hObject, ~, handles, varargin)
handles.output = hObject;
guidata(hObject, handles);

%%%%%%%%%%%%%%%%%%%%%%%%%%% output function %%%%%%%%%%%%%%%%%%%%%%%%%%
% --- Outputs from this function are returned to the command line.
function varargout = mFusionV3_OutputFcn(~, ~, handles) 
...
file=[Pathname,Filename];data=importdata(file);handles.Yraw_new= data;handles.trait= data(:,2:size(data,2));%there must not have missing value or NaN in 'file'.
set(handles.edit1,'String',file);handles.input=file;
...
% currentFolder = 'E:/Project/mFusionV3/';
...
clc;disp(['mFusion Version: 1.2']);disp(['Start Time: ',datestr(datetime('now'),'yyyy_mm_dd_HH_MM')]);
